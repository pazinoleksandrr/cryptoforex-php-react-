...
*
*/
define('APP_BASE_URL', 'https://crm.cryptoforex.trade/');
...
*/
define('APP_ENC_KEY', '4950ccad51d56f0b78cfe7507676b6e2');
 ...
 */
define('APP_DB_PASSWORD', 'Fs3h$Klpd(jkosQGc$e5');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'bitrihub_crm');
...
//front-side
defined('FRONT_URL')            OR define("FRONT_URL", 'https://back.cryptoforex.trade/api');
defined('FRONT_KEY')            OR define('FRONT_KEY', 'c9d2312-7f05-11ee-b962-0242ac120002');
